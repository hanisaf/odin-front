  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [MatIconModule,MatSelectModule,MatOptionModule,MatFormFieldModule,FormsModule,MatAutocompleteModule,MatButtonModule,MatButtonToggleModule,MatCardModule,
        ...
        TourModule.forRoot(),TourMatMenuModule.forRoot(),RouterTestingModule,BrowserAnimationsModule
      ],
      providers: [D3Service,AnalyticsService, CookieService,TourService, MessageService,ElasticService, RenderingService,HttpClient, HttpHandler ]
    }).compileComponents();
  }));
